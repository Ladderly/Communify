...
const QuestionCard: FC<Props> = ({ children, tag, questionID, deleted }) => {
  ...
  return (
    <>
      <div
        className={
          !deleted ? "w-full px-2 sm:w-2/5 sm:px-0 sm:mx-auto" : "w-full"
        }
      >
            ...
            <div className="px-5 pt-3">
              ...
              <button>
                {!deleted ? (
                  ...
                  <MdDelete className="absolute w-6 h-6 text-red-500 cursor-pointer right-2 top-2" />
                )}
              </button>
